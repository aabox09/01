...
let subPath = 'link';
let password = 'as000.&';
let serverPool = ['ProxyIP.SG.CMLiussss.net:443'];
let yourUUID = '81c202a1-c6b3-4082-8e6a-807685eaa459';
let cfip = [
	'ip.sb', 'time.is', 'skk.moe', 'www.visa.com.tw', 'www.visa.com.hk', 'www.visa.com.sg',
	'cf.090227.xyz','cf.877774.xyz', 'cdns.doon.eu.org', 'usa.visa.com','myanmar.visa.com','www.shopify.com','www.ipget.net','malaysia.com','cloudflare.9jy.cc','ns5.cloudflare.com','cf.zhetengsha.eu.org'
]; 
